...
<script>
    ...
    export default {
        ...
        data() {
            return {
                list: [
                    { img: 'http://r96v3h7g2.hd-bkt.clouddn.com/FjjqFqwsgk8DIgZuVBOPs-F2M56b' },
                    { img: 'http://r96v3h7g2.hd-bkt.clouddn.com/FjYHkNb0WUvmv2gJF7z39HUuOLq0' },
                    { img: 'http://r96v3h7g2.hd-bkt.clouddn.com/Fj5doDfB80v5JW9s17RhQI-7SklD' }
                ],
                musicPlay: false,
                musicFirst: true,
                soundPlay: false,
